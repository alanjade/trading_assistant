...
// ── Type Guards ───────────────────────────────────────────────────────────────
export function isHLineDrawing(d: Drawing): d is HLineDrawing {
  return d.kind === 'hline';
}

export function isTrendLineDrawing(d: Drawing): d is TrendLineDrawing {
  return d.kind === 'trendline';
}

export function isFibDrawing(d: Drawing): d is FibDrawing {
  return d.kind === 'fib';
}

export function isRectDrawing(d: Drawing): d is RectDrawing {
  return d.kind === 'rect';
}
...
// ─────────────────────────────────────────────────────────────────────────────
export const TOOL_DEFAULTS: Record<
  DrawingToolKind,
